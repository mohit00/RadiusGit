...
getEventList() {
   this.service.getalerts(this.page, this.size, this.sort).subscribe(res => {
     console.log("Alert +______"+JSON.stringify(res))
     this.showpagi = true;
     ...
     this.displayList = res._embedded.alerts;
    
  });
}
getCountAttribute(){
  this.service.getAlertCount().subscribe(res=>{
...
ngOnInit() {
  ...
  Page(data) {
    ...
    searchresult(name: String, description: String) {
      if (description) {
        this.service.getAlertdescript(name, description).subscribe(res => {
          this.displayList = res;
          this.showpagi = false;
             });
      } else {
        this.service.getSearchAlert(name , description).subscribe(res => {
          this.displayList = res;
          this.showpagi = false;
             });
      }
