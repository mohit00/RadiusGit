...
import { PreferencesAccountDialogComponent } from './preferences-account-dialog/preferences-account-dialog.component';
...
export class PreferencesAccountComponent implements OnInit {
  ...
  open() {
      ...
      this.bsModalRef = this.modalService.show(PreferencesAccountDialogComponent,  {initialState, class: 'gray modal-lg',backdrop: 'static' });
  ...
  ngOnInit() {
    ...
    this.getEventList();
      ...
      detail(data) {
       ...
       let id =    this.service.getSplitId(data._links.self.href);
          ...
          this.service.setId(id , 'preference/Account/Detail');
  
        }else{
          this.service.setId(data.id , 'preference/Account/Detail');
      ...
      edit(data) {
        ...
        this.bsModalRef = this.modalService.show(PreferencesAccountDialogComponent,  {initialState, class: 'gray modal-lg' });
    ...
    Page(data) {
      ...
      searchresult(name: String, description: String) {
        if (description) {
          this.service.getPreferencedescript(name, description).subscribe(res => {
            this.displayList = res;
            this.showpagi = false;
               });
        } else {
          this.service.getSearchPreference(name , description).subscribe(res => {
            this.displayList = res;
            this.showpagi = false;
               });
        }
