...
import { PreferencesThingsDialogComponent } from './preferences-things-dialog/preferences-things-dialog.component';
...
@Component({
  selector: 'app-preferences-things',
  templateUrl: '../../table/table.html',
  styleUrls: ['../../table/table.scss']
})
export class PreferencesThingsComponent implements OnInit {
  ...
  open() {
      ...
      this.bsModalRef = this.modalService.show(PreferencesThingsDialogComponent,  {initialState, class: 'gray modal-lg',backdrop: 'static' });
  ...
  ngOnInit() {
    ...
    this.getEventList();
      ...
      edit(data) {
        if(this.showpagi){
          ...
          this.service.setId(id , 'preference/Things');
  
        }else{
          this.service.setId(data.id , 'preference/Things');
        ...
        this.bsModalRef = this.modalService.show(PreferencesThingsDialogComponent,  {initialState, class: 'gray modal-lg' });
    ...
    Page(data) {
      ...
      searchresult(name: String, description: String) {
        if (description) {
          this.service.getPreferenceThingdescript(name, description).subscribe(res => {
            this.displayList = res;
            this.showpagi = false;
               });
        } else {
          this.service.getSearchThingPreference(name , description).subscribe(res => {
            this.displayList = res;
            this.showpagi = false;
               });
        }
